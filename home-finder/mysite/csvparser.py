...
rows_affected = 0
for row in rows:
    mycursor.execute(house_query, (row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8], row[9], row[10], row[11], row[12], row[13], "2020-10-10 01:01:01.000001", "2020-10-10 01:01:01.000001", row[16], row[17], row[18], row[19]))
    mydb.commit() 
