...
import { Card, CardBody, Button,CardTitle,
    Row, Col, Form, Modal, Badge, Input, Container
}from 'reactstrap';
...
class RentOut extends React.Component {
    ...
    getUserListing = () => {
        axios.get("http://127.0.0.1:8000/api/allHouses", {
            headers: {
            ...
            <Container className="pb-4">
                ...
                <Row>
                    <Col md="4">
                        <Card>
                            <CardBody>
                                <h5 className="card-title">Rent out your house now!</h5>
                                <img className="card-img-top pb-2" src="/For-sale-sign.jpg" alt="Card image cap"/>
                    ...
                    {
                        this.state.userHouses.filter((house) => {
                            if (house.hide) {
                                return false;
                            }
                            return true;
                                ...
                                <Col md="4">
                                    <Card>
                                        <CardBody>
                                            ...
                                            <Button onClick={(e) => this.manageHouseToggle(e, house)} color="primary">Manage</Button>{' '}
                                        </CardBody>
                                    </Card>
                                </Col>
                            );
